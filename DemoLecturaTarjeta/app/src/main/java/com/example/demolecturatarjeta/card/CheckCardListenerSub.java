...
import static com.example.demolecturatarjeta.CardSearchErrorUtil.CARD_SEARCH_ERROR_REASON_MAG_EMV;
import static com.example.demolecturatarjeta.CardSearchErrorUtil.CARD_SEARCH_ERROR_REASON_MAG_READ;
...
public class CheckCardListenerSub extends AidlCheckCardListener.Stub {
    ...
    public void onFindRFCard() throws RemoteException {
        ...
        SmartPosApplication.getApp().mConsumeData.setCardType(ConsumeData.CARD_TYPE_RF);
