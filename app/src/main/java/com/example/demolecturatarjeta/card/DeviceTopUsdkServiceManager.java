...
public class DeviceTopUsdkServiceManager {
    ...
    private static final String TAG = "topwise - SDK - Clase: DeviceTopUsdkServiceManager";
    ...
    public AidlDeviceService mDeviceService;
    ...
    public static void getmDeviceServiceManager() {
        synchronized (DeviceTopUsdkServiceManager.class) {
            ...
            Log.d(TAG,"gz mDeviceServiceManager: " + mDeviceServiceManager);
            mDeviceServiceManager.mContext = SmartPosApplication.getApp();
    ...
    public static DeviceTopUsdkServiceManager getInstance() {
        Log.d(TAG,"mDeviceServiceManager: " + mDeviceServiceManager);
    ...
    public boolean bindDeviceService() {
        Log.i(TAG,"");
