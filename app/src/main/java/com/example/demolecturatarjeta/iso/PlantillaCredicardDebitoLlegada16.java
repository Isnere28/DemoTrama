...
public class PlantillaCredicardDebitoLlegada16 extends ISOBasePackager {
    protected ISOFieldPackager fld[] = {
            /*000*/ new IFA_NUMERIC(2, "Message Type Indicator"),
            /*001*/ new IFB_BITMAP(16, "Bitmap"),
            /*002*/ new IFA_NUMERIC(9,"PAN"),
            ...
            /*055*/ new IFA_NUMERIC(14, "Data EMV"),
    ...
    public PlantillaCredicardDebitoLlegada16() {
        super();
